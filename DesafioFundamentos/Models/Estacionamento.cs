namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            //Verifica se a placa já esta cadastrada no sistema
            if (veiculos.Any(x => x.ToUpper() == placa1.ToUpper())) 
            {
                Console.WriteLine("Cadastro Inválido. Essa placa já esta cadastrada no sistema");
            }else
            {
                veiculos.Add(placa1);
